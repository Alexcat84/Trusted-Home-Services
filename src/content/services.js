...
const EN = {
  ...
  cleaning: {
    ...
    metaDescription:
      'Pre-listing deep cleaning, move in and move out cleaning and odour treatment in Ottawa. The first job on site and the last one before photography.',
    intro:
      'This is where a job starts. Nobody can price a house they cannot see properly, and no trade works well around someone else’s mess. We clean first so the plan is made on what is actually there, then come back at the end, once the trades are out, so the property is photographed on the day it looks its best.',
    includes: [
      'A heavy pass at the start of the job and a lighter one before photography',
      ...
      'Construction dust cleared once the renovation work is finished',
    ],
    benefits: [
      { title: 'Everything after it goes faster', text: 'Painters, floor fitters and electricians all move quicker over clear surfaces, and the price they quote you is closer to the truth when they can see what they are quoting on.' },
...
const FR = {
  ...
  cleaning: {
    ...
    metaDescription:
      'Nettoyage en profondeur avant la mise en vente, nettoyage d’emménagement et de déménagement et traitement des odeurs à Ottawa. Le premier travail sur place et le dernier avant la séance photo.',
    intro:
      'C’est ici que le chantier commence. Personne ne peut chiffrer une maison qu’il ne voit pas comme il faut, et aucun corps de métier ne travaille bien dans le désordre des autres. Nous nettoyons d’abord pour que le plan repose sur ce qui est vraiment là, puis nous revenons à la fin, une fois les équipes parties, pour que la propriété soit photographiée le jour où elle paraît à son mieux.',
    includes: [
      'Un passage en profondeur au début du chantier et un plus léger avant les photos',
      'Nettoyage complet, des luminaires au plafond jusqu’aux plinthes',
      ...
      'Fenêtres, rails et appuis nettoyés des deux côtés',
      'Tapis et tissus d’ameublement nettoyés lorsqu’ils peuvent être sauvés',
      'Traitement des odeurs de fumée, d’animaux et de cuisson, à la source plutôt qu’en les masquant',
      'Poussière de chantier retirée une fois les travaux terminés',
    ],
    benefits: [
      ...
      { title: 'L’odeur décide plus qu’on ne l’admet', text: 'Un acheteur n’arrive pas toujours à nommer ce qui cloche, mais il repart plus vite. Traiter l’odeur à la source, la peinture ne le fera pas pour vous.' },
      { title: 'Propre veut dire entretenu', text: 'On suppose qu’une maison impeccable a aussi été soignée là où ça ne se voit pas. Petit travail, grande impression.' },
    ],
    faq: [
