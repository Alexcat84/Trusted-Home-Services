    ...
    <header className="header" id="header">
      <div className="header-inner">
        <a href={`#${hash('home')}`} className="logo-wrap" aria-label="Trusted Home Services - Home">
          <img src="/images/Logo v3 Inverted.jpg" alt="Trusted Home Services" className="logo-img" />
        </a>
      ...
      <header className="privacy-header">
        <div className="container privacy-header-inner">
          <a href={`#${homeHash}`} onClick={goHome} className="privacy-logo-link" aria-label="Trusted Home Services - Home">
            <img src="/images/Logo v3 Inverted.jpg" alt="" className="privacy-logo" />
          </a>
    ...
    <footer className="footer">
      <div className="container footer-inner">
        <div className="footer-brand">
          <img src="/images/Logo v3 Inverted.jpg" alt="Trusted Home Services" className="footer-logo" />
